...
// no records exist
func GetAllEstructuraInvestigacionTg(query map[string]string, fields []string, sortby []string, order []string,
	offset int64, limit int64) (ml []interface{}, err error) {
	o := orm.NewOrm()
	qs := o.QueryTable(new(EstructuraInvestigacionTg)).RelatedSel()
	// query k=v
	for k, v := range query {
